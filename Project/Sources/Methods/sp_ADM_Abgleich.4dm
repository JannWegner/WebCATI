...
Case of 
	: (Current machine:C483="cati-server")
		$vs_ADMPfad:="Mac HD Cati:Users:db_orga:Documents:CATI:CATI-Allgemein:ADM-Log:"
	: (Current machine:C483="4d-server-1")
		$vs_ADMPfad:="4D-Server-1:Users:datenbank:Documents:CATI-Aktuell:ADM-Log:"
	: (Current machine:C483="Saturn")
		$vs_ADMPfad:="Mac HD Saturn:Users:interviewer:Documents:cati eMac:CATI-Aktuell:ADM-Log:"
	Else 
		$vs_ADMPfad:=""
End case 
