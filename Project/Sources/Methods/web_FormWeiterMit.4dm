	...
	: ($vt_Formular="Telefon")
		...
		Case of 
			...
			: ($vt_Antwort="9")  // Max
				...
				web_SessionUpdate(New collection:C1472("LetzteURL"; "Abbruch"))
		End case 
		e_AktTelefonNummer.Interviewer:=Current user:C182
	...
	: ($vt_Formular="Abnahme")
		...
		Case of 
			: ($vt_Antwort="1")  // Interview
				...
				e_AktTelefonNummer.Historie:=String:C10(Current date:C33)+"/"+String:C10(Current time:C178)+" * "+Current user:C182+" * Interview läuft"+Char:C90(13)+e_AktTelefonNummer.Historie
				
			: ($vt_Antwort="2")  // Termin
				e_AktTelefonNummer.StatusErklärung:="Termin"
				web_SessionUpdate(New collection:C1472("LetzteURL"; "Termin"))
				e_AktTelefonNummer.Historie:=String:C10(Current date:C33)+"/"+String:C10(Current time:C178)+" * "+Current user:C182+" * Wiedervorlage/Termin"+Char:C90(13)+e_AktTelefonNummer.Historie
			: ($vt_Antwort="3")  // Ausfall
				e_AktTelefonNummer.StatusErklärung:="Ausfall"
				web_SessionUpdate(New collection:C1472("LetzteURL"; "Abbruch"))
				e_AktTelefonNummer.Historie:=String:C10(Current date:C33)+"/"+String:C10(Current time:C178)+" * "+Current user:C182+" * Abbruch/Ausfall"+Char:C90(13)+e_AktTelefonNummer.Historie
		End case 
	: ($vt_Formular="Interview")
		...
		Case of 
			: ($vt_Antwort="OK")
				...
				e_AktTelefonNummer.Historie:=String:C10(Current date:C33)+"/"+String:C10(Current time:C178)+" * "+Current user:C182+" * Interview beendet"+Char:C90(13)+e_AktTelefonNummer.Historie
				web_SessionUpdate(New collection:C1472("LetzteURL"; "Adresse"; "AdrPKID"; ""; "Fassung"; ""; "FbNr"; 0; "LetzteFrage"; ""; "InfoFeld"; ""))
			: ($vt_Antwort="Abbruch")
				e_AktTelefonNummer.StatusErklärung:="Interview-Abbruch"
				web_SessionUpdate(New collection:C1472("LetzteURL"; "Abbruch"))
				e_AktTelefonNummer.Historie:=String:C10(Current date:C33)+"/"+String:C10(Current time:C178)+" * "+Current user:C182+" * Abbruch/Im Interview"+Char:C90(13)+e_AktTelefonNummer.Historie
		End case 
End case   // Formularwahl

If ($vl_APPos>0)
	If (at_FormVarValues{$vl_APPos}#"")
		e_AktTelefonNummer.Kommentar:=String:C10(Current date:C33)+" "+String:C10(Current time:C178)+"   "+Current user:C182+Char:C90(13)+" Alter AP '"+e_AktTelefonNummer.aktAnsprechp+"' geändert!"+Char:C90(13)+"______________________________________"+Char:C90(13)+e_AktTelefonNummer.Kommentar
...
If ($vl_NummerPos>0)
	If (at_FormVarValues{$vl_NummerPos}#"")
		e_AktTelefonNummer.Kommentar:=String:C10(Current date:C33)+" "+String:C10(Current time:C178)+"   "+Current user:C182+Char:C90(13)+" Alte TelNr. '"+e_AktTelefonNummer.Telefon1+"' geändert!"+Char:C90(13)+"______________________________________"+Char:C90(13)+e_AktTelefonNummer.Kommentar
...
If ($vl_NeuKommTextPos>0)
	If (at_FormVarValues{$vl_NeuKommTextPos}#"")
		e_AktTelefonNummer.Kommentar:=String:C10(Current date:C33)+" "+String:C10(Current time:C178)+"   "+Current user:C182+Char:C90(13)+at_FormVarValues{$vl_NeuKommTextPos}+Char:C90(13)+"______________________________________"+Char:C90(13)+e_AktTelefonNummer.Kommentar
	End if 
End if 
